...
namespace LanzhouBeefNoodles.Models
{
    public class DbInitializer
    {
        ...
        public static void FeedSeed(AppDbContext context) 
        {
            ...
            context.AddRange(
                new Feedback { Name = "张三", Email = "noname@hotmail.com", Message = "真的好细好细好细啊", CreateDateUTC = DateTime.UtcNow },
                new Feedback { Name = "李波", Email = "noname@hotmail.com", Message = "还是挺细的", CreateDateUTC = DateTime.UtcNow },
                new Feedback { Name = "王二", Email = "noname@hotmail.com", Message = "比细的粗点，比二细细点", CreateDateUTC = DateTime.UtcNow },
                new Feedback { Name = "郑冰", Email = "noname@hotmail.com", Message = "粗的才有嚼劲", CreateDateUTC = DateTime.UtcNow },
                new Feedback { Name = "秋风", Email = "qiufeng@hotmail.com", Message = "打卤面很不错，下来再来", CreateDateUTC = DateTime.UtcNow }
            );
